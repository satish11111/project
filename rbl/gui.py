...
class Diabetes(QWidget):
    ...
    def clfn(self):
        ...
        self.details.setText("This model uses Gradinet boosting  Machine classifier.\n\nWe have used PIMA Indians diabetes dataset from UCI archive.")
    ...
    def test_input(self) -> None:
        ...
        self.model_details.setText("This model uses Gradinet boosting  Machine classifier.\n\nWe have used PIMA Indians diabetes dataset from UCI archive.")
